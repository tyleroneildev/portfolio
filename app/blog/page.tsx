    ...
    <div className='px-8 pt-24 pb-40 sm:px-6'>
      <main className='mx-auto grid w-full max-w-225 gap-10'>
        <header className='grid gap-3'>
          ...
          <p className='max-w-2xl text-base text-[#cfcac2]'>A collection of personal notes.</p>
        </header>
            ...
            {posts.map((post) => (
              ...
              >
                <div className='grid gap-2'>
                  ...
                  <p className='text-xs tracking-[0.2em] text-[#6f6f6f] uppercase'>{formatBlogDate(post.date)}</p>
